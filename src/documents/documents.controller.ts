...
export class DocumentsController {
  ...
  @ApiOperation({
    ...
    description:
      'Upload a new document with metadata. The document can be associated with a booking if bookingId is provided.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve documents with optional filtering by type, status, booking, and user. Supports pagination.',
  })
  @ApiQuery({
    name: 'type',
    required: false,
  ...
  async getDocuments(
    ...
    @Query('myDocuments', new DefaultValuePipe(false), ParseBoolPipe)
    myDocuments?: boolean,
  ...
  @ApiOperation({
    ...
    description:
      'Update document metadata. Only the document owner can update their documents.',
  })
  @ApiParam({ name: 'id', description: 'Document ID', type: 'string' })
  ...
  @ApiOperation({
    ...
    description:
      'Delete a document and its associated file. Only the document owner can delete their documents.',
  })
  @ApiParam({ name: 'id', description: 'Document ID', type: 'string' })
  ...
  async verifyDocument(
    ...
    return this.documentsService.verifyDocument(id, 'admin123'); // Replace with actual admin user ID
  }
  ...
  @ApiOperation({
    ...
    description:
      'Reject a document with reason. Only admin users can reject documents.',
  })
  @ApiParam({ name: 'id', description: 'Document ID', type: 'string' })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Download the actual document file. Only the document owner or admin can download.',
  })
  @ApiParam({ name: 'id', description: 'Document ID', type: 'string' })
  @ApiResponse({
    status: 200,
  ...
  async getExpiringDocuments(
    ...
    return this.documentsService.getExpiringDocuments(days); // Replace with actual user ID
  }
